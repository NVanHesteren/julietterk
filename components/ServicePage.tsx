...
import { FadeUp, FadeIn, StaggerChildren, StaggerItem } from "./Animate";
  ...
  return (
    <>
      ...
      <section className="py-16 md:py-24 bg-sage-pale">
        <div className="max-w-wide mx-auto px-[5vw]">
          <FadeUp className="text-center mb-10 max-w-[720px] mx-auto">
              ...
              return (
                <StaggerItem key={relSlug}>
                  <Link
                    ...
                    className="group bg-cream p-6 rounded border border-ink/10 flex flex-col gap-2.5 transition-all duration-300 hover:border-sage hover:-translate-y-0.5 no-underline h-full"
                  >
